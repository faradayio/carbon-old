...
In addition to the quick start and full documentation, check out the {integration guide}[link:files/doc/INTEGRATION_GUIDE_rdoc.html]. It has code examples from our real-life migration followed by brief developer commentary.
